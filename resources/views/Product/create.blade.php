                    ...
                    <div class="col-4 mx-auto bg-info">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><a class="btn btn-primary" href="{{ route('products.index') }}"> Back</a></h3>
                            </div>
                            ...
                            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" rows="10" name="description" placeholder="Enter product description" required></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dynamic_field">
                                                <tr>
                                                    <td><input type="text" name="size[]" placeholder="Product size" class="form-control name_list" /></td>
                                                    <td><input type="text" name="color[]" placeholder="Product color" class="form-control name_list" /></td>
                                                    <td><input type="number" name="price[]" placeholder="Product price" class="form-control name_list" /></td>
                                                    <td><input type="number" name="amount[]" placeholder="Product amount" class="form-control name_list" /></td>
                                                    <td><input type="number" name="price_sale[]" placeholder="Product price sale" class="form-control name_list" /></td>
