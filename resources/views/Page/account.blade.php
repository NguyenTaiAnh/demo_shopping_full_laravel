...
<!-- Begin Torress's Page Content Area -->
<main class="page-content">
    <!-- Begin Torress's Account Page Area -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        @foreach ($orders as $order)
                                            <tr>
                                                <td><a class="account-order-id" href="javascript:void(0)">{{$order->code}}</a></td>
                                                <td>{{$order->created_at}}</td>
                                                <td>{{$order->order_status->first()['name']}}</td>
                                                <td>{{$order->total}}$</td>
                                                <td><a href="{{ route('vieworder',$order->id) }}" class="torress-btn torress-btn_dark torress-btn_sm"><span>View</span></a>
                                                </td>
                                            </tr>
                                        @endforeach
    ...
    <!-- Torress's Account Page Area End Here -->
</main>
<!-- Torress's Page Content Area End Here -->
